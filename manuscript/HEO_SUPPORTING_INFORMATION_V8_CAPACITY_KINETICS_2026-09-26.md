# Supporting Information v8 — Capacity–Kinetics and Conventional GITT Diffusivity Audit

## Ball Milling and Mg Incorporation Reshape Conversion Dynamics in Spinel High-Entropy Oxide Anodes

**Date:** 2026-09-26  
**Status:** aligned to `HEO_MANUSCRIPT_V9_AFM_CAPACITY_KINETICS_2026-09-26.md`; BM contradiction prioritized, conventional-GITT ranking audit retained, and microkinetic interpretation bounded as an existence proof.
...
The pulse-polarization comparison leads to the same caution. A larger conventional $D_{\mathrm{app}}$ for BM-HEO does not systematically correspond to a smaller pulse voltage excursion. This mismatch is documented in Figure S23 rather than used as an independent mechanistic assignment.
...
- Figure S23: conventional GITT apparent-diffusivity audit for HEO versus BM-HEO.
...
**Available from current Yoon-Lab/project files:** S14–S23 in principle; final publication artwork remains to be assembled.
