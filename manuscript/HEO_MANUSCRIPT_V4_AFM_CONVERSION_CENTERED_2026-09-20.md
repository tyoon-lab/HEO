...
**Figure 4. The late-stage excess relaxation tracks the first-cycle cathodic conversion feature.** (a) State-resolved \(\Delta E_{\mathrm{relax}}\) and the low-voltage excess response. (b) Background-subtracted GITT excess relaxation plotted on a voltage axis together with the independently derived first-cycle cathodic dQ/dV response for the four samples. (c) Correspondence between dQ/dV and GITT excess-peak voltages; the absolute mismatch is 18–32 mV across the four samples. (d) Excess-polarization peak amplitude versus FWHM-like capacity width, with marker area proportional to normalized excess area. The voltage correspondence localizes the excess response to the conversion window but does not assign a unique microscopic conversion step.
