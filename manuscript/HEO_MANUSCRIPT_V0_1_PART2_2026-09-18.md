...
> Drafting rule: verified information is written directly. Unverified historical details are marked for collaborator/student confirmation rather than inferred.
...
The increase in interface is accompanied by a clear increase in first-cycle electrochemical utilization. Using the WonATech channel convention reported in the experimental record, the first charge/discharge capacities are 858.8/558.8 mAh g−1 for HEO and 1030.2/699.2 mAh g−1 for BM-HEO, giving initial Coulombic efficiencies of 65.1% and 67.9%, respectively. Ball milling therefore increases the two first-cycle capacity measures by approximately 20% and 25%, respectively. The corresponding Mg-containing electrodes deliver 814.8/514.0 mAh g−1 for Mg-HEO and 934.9/590.3 mAh g−1 for BM-Mg-HEO, with initial Coulombic efficiencies of approximately 63.1%. Ball milling still increases the first-cycle capacities of the Mg-containing material by ~15%, but both Mg-containing samples remain below their Mg-free counterparts. **[[Before final manuscript submission, verify whether the WonATech labels 'charge' and 'discharge' correspond to lithiation/delithiation in the half-cell and replace the terminology consistently throughout the manuscript.]]**

These first-cycle data already separate the effects of the two synthesis variables. Ball milling increases accessible capacity in both compositions, in agreement with the substantially enlarged surface area and electrochemically accessible interface. Mg incorporation has the opposite effect on capacity despite increasing, rather than decreasing, the BET surface area of the unmilled powder from 3.94 to 6.49 m2 g−1. The lower capacity of Mg-HEO therefore cannot be explained simply by loss of geometric surface area or reduced electrode/electrolyte contact. This contrast points instead to a change in the reaction pathway or in the fraction of the oxide that participates in conversion-type storage.

The cycling data reinforce this distinction. At 0.1 C with 10 wt% FEC, BM-HEO maintains a higher absolute capacity than HEO over 100 cycles, but its relative capacity retention is lower. Mg incorporation lowers the absolute capacity while improving the stability of the capacity with cycling. FEC improves the cycling response and was therefore used as the common electrolyte additive for the four-sample comparison, but FEC is not treated as an independent mechanistic variable in the present manuscript. The central comparison remains the effects of Mg and ball milling under a standardized electrolyte condition.

The rate-capability response further shows that the extra low-rate capacity generated by ball milling is not equivalent to uniformly faster reaction kinetics. As the applied rate increases, a substantial fraction of the additional low-rate capacity is lost and the four samples converge toward lower accessible capacities. This behavior is difficult to reconcile with a simple picture in which milling merely shortens a diffusion length and accelerates Li transport. The current data instead suggest that ball milling opens additional storage pathways that can be accessed at low rate but that remain associated with appreciable polarization and slow relaxation.
