...
**Scientific backbone:** Figure 1 → Figure 5 retained; Figure 4/5 interpretation updated to conversion-associated structural evolution  
...
**Figure 2. Conventional electrochemistry establishes accessibility and evolving conversion behavior before transient analysis.** (a) BET surface area and relative interfacial-capacitance metric. (b) First-cycle voltage profiles and capacity comparison for HEO, BM-HEO, Mg-HEO, and BM-Mg-HEO. (c) Cycling performance under the common FEC-containing electrolyte, with the corresponding no-FEC comparison used to show the interphase sensitivity of the high-interface electrodes. (d) Rate capability from 0.1 C to 5 C and recovery at 0.1 C. (e) Cycle-resolved differential-capacity response showing the pronounced first-cycle cathodic conversion feature and its evolution during subsequent cycling. Milling increases accessible capacity and high-rate utilization, whereas Mg lowers accessible capacity; these conventional measurements establish the material-level trends but do not by themselves distinguish transport, conversion, and post-conversion relaxation. **[[YOON LAB INPUT REQUIRED — confirm lithiation/delithiation label convention and final rate-sequence metadata.]]**
