...
The characterization is therefore organized into two main figures before electrochemical data are introduced. Figure 1 focuses on crystal structure, composition, and nanoscale phase/microstructure using the final XRD/ICP/TEM/SAED/EDS dataset. Figure 2 focuses on particle morphology and surface-related physicochemical changes, including SEM, particle/domain-size statistics, and BET surface area; XPS is included only if the final dataset is reproducible and mechanistically defensible. The CV-derived relative interfacial-capacitance metric is not treated as materials characterization and is retained in the Supporting Information as corroborating electrochemical-accessibility evidence.
