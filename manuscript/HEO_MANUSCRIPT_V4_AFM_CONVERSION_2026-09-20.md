...
Controlling conversion-type high-entropy oxide (HEO) anodes requires understanding how synthesis-induced structural changes affect both practical electrochemical performance and the underlying conversion reaction. Here, spinel Fe–Co–Ni–Cr–Mn HEO, ball-milled HEO (BM-HEO), Mg-containing HEO (Mg-HEO), and BM-Mg-HEO are compared to separate the consequences of mechanical processing and compositional modification. Ball milling increases BET surface area from 3.94 to 18.159 m² g⁻¹ and raises accessible capacity, whereas Mg incorporation lowers accessible capacity and shifts the first-cycle cathodic conversion feature to lower potential. These conventional performance trends are consistent with increased reaction accessibility after particle fragmentation and enhanced stabilization of oxide-derived states by Mg. Current-off analysis then reveals that the same structural modifications produce distinct relaxation behavior that cannot be inferred from capacity or rate performance alone. BM-HEO shows a longer model-free $t_{63}$ despite higher utilization, while Mg-HEO exhibits a substantially smaller relaxation amplitude without a shorter $t_{63}$. A late-stage GITT excess response is further quantified by its peak position, amplitude, width, and area; its peak voltage matches the independently derived first-cycle cathodic dQ/dV feature within 32 mV for all four materials, linking the transient response to conversion electrochemistry. Ball milling lowers and broadens this conversion-associated response, whereas Mg strongly suppresses it and shifts it to lower potential. A reduced spatial model shows that these experimentally observed trends are compatible with separate structural stabilization and relaxation contributions. The results establish a direct link between synthesis-controlled materials characteristics, electrochemical performance, and state-resolved conversion behavior in spinel HEO anodes.
...
Ball milling and Mg incorporation are known to modify this structurally and chemically complex conversion process, but they do so through different material changes. For the same nominal (FeCoNiCrMn)₃O₄ composition, mechanical processing and particle fragmentation have been reported to alter electrochemical response, increase conversion reversibility, and enhance interfacial storage.[6,12] High-energy milling can also perturb the spinel/rock-salt balance in related spinel HEOs,[11] while morphology changes rate and cycling behavior.[13] Mg-containing conversion HEOs show a different trend: electrochemically inactive Mg-derived components can stabilize oxide-derived structures,[8–10] and operando imaging has associated higher Mg content with improved structural retention but lower accessible capacity.[9] These studies establish important structural and performance consequences of milling and Mg incorporation. What remains much less clear is how those material-level changes are translated into state-resolved electrochemical behavior—where the conversion response appears, how strongly and broadly it develops over reaction state, and how the nonequilibrium state relaxes after current interruption.

This gap is especially relevant to galvanostatic intermittent titration measurements. When GITT has been applied to HEO anodes, it has generally been used to estimate and compare an apparent Li-ion diffusion coefficient, including in mechanically processed (FeCoNiCrMn)₃O₄.[6] The pulse and current-off transient, however, contain information beyond a single diffusivity. Staircase-GITT has been used to extract state-dependent kinetic parameters,[23] electrochemical modeling has incorporated the complete transient rather than only a selected diffusion window,[24] and phase-transforming electrodes have been analyzed in terms of phase-boundary mobility and transformation kinetics.[21,22] Operando structural measurements further show that current interruption can be followed by stepwise structural relaxation rather than simple concentration equilibration alone.[26] For a reconstructive conversion electrode, preserving the state-resolved polarization and relaxation response can therefore reveal electrochemical consequences of structural evolution that are lost when the measurement is reduced to one apparent diffusion coefficient.

Here, HEO, BM-HEO, Mg-HEO, and BM-Mg-HEO are compared under common electrochemical conditions to determine how known structural perturbations are translated into measurable conversion and relaxation behavior. Rather than relying on a single apparent diffusivity, the current-off response is resolved into fast polarization, relaxation magnitude and characteristic time, and a late-stage excess response whose peak position, amplitude, and width are quantified as functions of reaction state. Comparison with the independently derived first-cycle differential-capacity response localizes the excess relaxation to the conversion region, while a reduced spatial model is used to test whether the experimentally observed combinations of accessibility, conversion response, and relaxation are physically compatible with separate stabilization and structural-relaxation contributions. Ball milling increases electrochemical accessibility while broadening and redistributing the conversion-associated response and lengthening relaxation, whereas Mg shifts the conversion response to lower potential and strongly suppresses its magnitude without accelerating relaxation. The study therefore translates known materials-level modifications into state-resolved electrochemical descriptors of conversion and relaxation.
