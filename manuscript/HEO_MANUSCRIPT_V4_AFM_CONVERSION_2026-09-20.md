...
**Scientific backbone:** Figures 1–2 characterization → Figure 3 conventional electrochemistry → Figure 4 current-off decoupling → Figure 6 conversion assignment → Figure 6 reduced model  
...
Spinel high-entropy oxide (HEO) anodes store Li through reconstructive conversion reactions, making synthesis-induced changes difficult to assign to transport or structural evolution alone. Fe–Co–Ni–Cr–Mn HEO, ball-milled HEO (BM-HEO), Mg-containing HEO (Mg-HEO), and BM-Mg-HEO are compared in a 2 × 2 design. Ball milling raises BET surface area from 3.94 to 18.159 m² g⁻¹ and increases capacity, yet the model-free t63 lengthens from 8.68 to 11.57 min. The late-stage excess relaxation decreases from 70.8 to 44.1 mV and broadens from 354 to 430 mAh g⁻¹. Crucially, its peak voltage coincides with the first-cycle cathodic differential-capacity feature within 32 mV across all four samples, linking the GITT response to conversion electrochemistry. Mg-HEO shows lower accessible capacity, a strongly suppressed excess peak of 15.9 mV, and a cathodic feature shifted to lower potential, while t63 remains slower than HEO. A reduced spatial model reproduces the observed ordering without refitting when Mg stabilization and milling-induced heterogeneity are treated as independent coordinates. Ball milling therefore redistributes accessible conversion, whereas Mg suppresses and delays conversion through stabilization of the oxide-derived parent/intermediate state.

**Keywords:** high-entropy oxide; conversion anode; ball milling; magnesium incorporation; GITT; electrochemical relaxation

# 1. Introduction

By accommodating multiple principal cations within a common oxide lattice, high-entropy oxides (HEOs) create chemically diverse local environments and multiple redox centers while retaining a single dominant crystal structure.[1,2] This compositional freedom is particularly attractive for electrochemical energy storage, where local coordination, redox chemistry, structural stability, and ion transport can all influence performance.[2] Spinel (FeCoNiCrMn)₃O₄ is a representative conversion-type HEO anode: single-phase spinel formation has been established,[3] and reversible capacities of approximately 680 mAh g⁻¹ at low current density and 596.5 mAh g⁻¹ after 1200 cycles at 2.0 A g⁻¹ have been reported for this nominal composition.[4,6]

Lithium storage in spinel (FeCoNiCrMn)₃O₄ proceeds through substantial structural reconstruction and conversion rather than simple insertion into an intact host. Atomic-scale analysis has shown Mn nanocrystal formation already at 0.5 V lithiation and metallic Cr, Fe, Ni, and Co at deeper lithiation,[5] directly demonstrating progressive conversion in the low-voltage region. Complementary in-situ XRD/ex-situ TEM studies resolved a spinel → mixed spinel/rock-salt → rock-salt pathway,[7] while recent work describes rock-salt-like intermediates coexisting with Li₂O and metallic products and identifies oxygen migration as an important kinetic process during conversion.[20] Lithiation of these HEOs therefore involves coupled nucleation, cation/oxygen rearrangement, phase-boundary motion, strain accommodation, and heterogeneous conversion over a broad reaction interval.

Ball milling and Mg incorporation are known to modify this structurally and chemically complex conversion process, but they do so through different material changes. For the same nominal (FeCoNiCrMn)₃O₄ composition, mechanical processing and particle fragmentation have been reported to alter electrochemical response, increase conversion reversibility, and enhance interfacial storage.[6,12] High-energy milling can also perturb the spinel/rock-salt balance in related spinel HEOs,[11] while morphology changes rate and cycling behavior.[13] Mg-containing conversion HEOs show a different trend: electrochemically inactive Mg-derived components can stabilize oxide-derived structures,[8–10] and operando imaging has associated higher Mg content with improved structural retention but lower accessible capacity.[9] These studies establish important structural and performance consequences of milling and Mg incorporation. What remains much less clear is how those material-level changes are expressed quantitatively in the electrochemical conversion process itself—when conversion becomes prominent, how strongly and broadly it proceeds over reaction state, and how the nonequilibrium state relaxes after current interruption.

This gap is especially relevant to galvanostatic intermittent titration measurements. In HEO anode studies, GITT has commonly been used to compare an apparent Li-ion diffusion coefficient, including in mechanically processed (FeCoNiCrMn)₃O₄.[6] More broadly, however, the GITT pulse and relaxation contain information beyond a single diffusivity. Staircase-GITT has been used to extract state-dependent kinetic parameters,[23] electrochemical modeling has incorporated the complete transient rather than only a selected diffusion window,[24] and phase-transforming electrodes have been analyzed in terms of phase-boundary mobility and transformation kinetics.[21,22] Operando structural measurements further show that current interruption can be followed by stepwise structural relaxation rather than simple concentration equilibration alone.[26] For a reconstructive conversion electrode, reducing the full response to one apparent diffusion coefficient can therefore obscure how structural transformation, polarization, and relaxation are coupled.

Here, HEO, BM-HEO, Mg-HEO, and BM-Mg-HEO are compared under common electrochemical conditions to determine how known structural perturbations are translated into measurable conversion and relaxation behavior. Rather than relying on a single apparent diffusivity, the current-off response is resolved into fast polarization, relaxation magnitude and characteristic time, and a late-stage excess response whose peak position, amplitude, and width are quantified as functions of reaction state. Comparison with the independently derived first-cycle differential-capacity response localizes the excess relaxation to the conversion region, while a reduced spatial model tests whether the observed trends can arise from independent stabilization and structural-relaxation effects. The analysis shows that ball milling increases electrochemical accessibility while broadening and redistributing conversion and lengthening relaxation, whereas Mg shifts conversion to lower potential and strongly suppresses the accessible conversion response without accelerating relaxation. In this way, structural modifications previously identified primarily through materials characterization and conventional performance measurements are translated into quantitative electrochemical signatures of conversion and relaxation.

# 2. Results and Discussion

## 2.1. Mg incorporation and ball milling create distinct structural and interfacial perturbations

The four samples provide matched comparisons of composition and mechanical processing (Figures 1 and 2). HEO and BM-HEO isolate the effect of milling in the Mg-free composition, while Mg-HEO and BM-Mg-HEO provide the corresponding comparison after Mg incorporation. The parent material belongs to the established five-cation spinel HEO family,[3,4] allowing the electrochemical consequences of the two perturbations to be compared without changing the underlying material class.
...
The characterization is therefore organized into two main figures before electrochemical data are introduced. Figure 1 focuses on crystal structure, composition, and nanoscale phase/microstructure using the final XRD/ICP/TEM/SAED/EDS dataset. Figure 2 focuses on particle morphology and surface-related physicochemical changes, including SEM, particle/domain-size statistics, and BET surface area; XPS is included only if the final dataset is reproducible and mechanistically defensible. The CV-derived relative interfacial-capacitance metric is not treated as materials characterization and is introduced with the electrochemical data in Figure 3.

Together, these measurements establish two qualitatively different perturbations before cycling: Mg produces a comparatively modest lattice/compositional modification of the parent spinel-type material, whereas ball milling strongly changes particle/microstructural characteristics and physical surface area. The next question is how these known materials-level changes appear in the electrochemical response.

## 2.2. Conventional electrochemistry establishes accessibility and evolving conversion behavior

The electrochemical consequences of milling and Mg incorporation are first evident in the conventional measurements (Figure 3). Under the common FEC-containing electrolyte, the instrument-reported first-cycle capacity pairs are 901.25/609.12 mAh g⁻¹ for HEO, 1056.10/782.08 mAh g⁻¹ for BM-HEO, 731.15/458.91 mAh g⁻¹ for Mg-HEO, and 944.07/580.83 mAh g⁻¹ for BM-Mg-HEO. The corresponding initial Coulombic efficiencies are 67.59%, 74.05%, 62.77%, and 61.52%, respectively. Ball milling therefore increases the accessible first-cycle capacity in both compositions, whereas Mg incorporation lowers capacity relative to the corresponding Mg-free material. The milling trend is consistent with previous observations that progressive fragmentation of (FeCoNiCrMn)₃O₄ increases conversion reversibility and interfacial storage,[12] while the lower capacity of the Mg-containing materials is directionally consistent with reports in which electrochemically inactive Mg-containing oxide domains improve structural retention at the expense of accessible redox capacity.[8–10]

**[[YOON LAB INPUT REQUIRED — after confirming the WonATech convention, replace “instrument-reported first-cycle capacity pairs” with the correct lithiation/delithiation terminology throughout the manuscript and Figure 2 caption.]]**

Cycling measurements provide the next level of comparison. With 10 wt% FEC, BM-HEO maintains the highest absolute capacity over 100 cycles, while the Mg-containing electrodes remain at lower absolute capacity. In the corresponding cells without FEC, capacity decay is stronger, particularly for the high-interface ball-milled electrodes. FEC is therefore treated as a common interphase-control condition rather than as a mechanistic variable of the four-material comparison. The result is consistent with the broader HEO literature in which particle refinement can enhance reaction accessibility and interfacial storage,[12] but it also emphasizes that the additional interface carries an interphase penalty that depends strongly on electrolyte chemistry. The present cycling data are therefore used to establish practical utilization and retention rather than to infer a unique conversion mechanism.

Rate capability shows a similarly important distinction between absolute utilization and normalized retention. BM-HEO retains the highest absolute capacity across the tested sequence from 0.1 C to 5 C and recovers the higher capacity after returning to 0.1 C. Milling also increases the absolute rate capacity of the Mg-containing material. Mg-HEO, despite its lower absolute capacity, retains a comparatively large fraction of its initial capacity at high rate. This distinction is important because conventional rate retention alone could be interpreted as favorable kinetics even when the accessible reaction extent is substantially reduced. The rate data therefore establish that practical high-rate utilization and the amount of conversion accessed are not interchangeable measures of intrinsic reaction speed.

Cycle-resolved differential-capacity curves further show that the electrochemical reaction itself evolves strongly after the first lithiation. All four materials exhibit a pronounced first-cycle cathodic feature in the low-voltage region that becomes substantially broader and lower in amplitude in subsequent cycles. This behavior is consistent with the reconstructive nature of spinel HEO lithiation reported previously: Mn nanocrystals appear near 0.5 V and additional metallic transition-metal species form at deeper lithiation,[5] while related studies show that the pristine HEO structure is not simply restored after the first conversion cycle and that subsequent cycling proceeds through reconstructed nanoscale states.[7,10] Within the present four-material set, the first-cycle cathodic feature occurs at lower potential after Mg incorporation and shifts partially back toward higher potential after milling. The quantitative peak positions are analyzed independently in Figure 4; the cycle-resolved dQ/dV data in Figure 3 are used here to establish that the conversion signature is strongly first-cycle dependent and remains structurally evolved thereafter.

The conventional measurements therefore reproduce the broad material trends expected from prior HEO studies—milling increases accessible capacity and rate utilization, whereas Mg lowers accessible capacity while modifying the conversion response. They do not, however, determine whether these changes originate from faster Li transport, a change in the onset or extent of conversion, or a change in the relaxation of the converted state. This ambiguity motivates direct analysis of the GITT current-off transient.
