# HEO Manuscript Architecture and Literature Positioning v2 — AFM / conversion-centered

**Date:** 2026-09-20  
**Current first target:** Advanced Functional Materials

## Positioning lock

This remains an HEO materials/mechanism paper, not a GITT-method paper.

The central materials message is now more specific:
- ball milling primarily increases electrochemical accessibility and redistributes conversion over a broader set of local reaction conditions;
- Mg primarily stabilizes an oxide-derived parent/intermediate state, suppressing and delaying deeper conversion;
- post-pulse relaxation time is an independent observable and does not track capacity or polarization amplitude monotonically.

The new Figure 4 experimental cross-check is central to this positioning. Across HEO, BM-HEO, Mg-HEO, and BM-Mg-HEO, the first-cycle cathodic dQ/dV peak and the GITT excess-relaxation peak agree within 32 mV. This supports a conversion/transformation-associated interpretation of the late-stage GITT feature without claiming one unique microscopic conversion step.

For AFM, the narrative should be written as:
**composition/process → structure/interface → accessibility and conversion → electrochemical function**.

GITT/current-off analysis is the diagnostic tool used to resolve the materials response, not the novelty claim by itself.
...
5. Connect conversion-associated structural evolution to additional polarization physics through nucleation/phase-boundary contributions [17–20].
