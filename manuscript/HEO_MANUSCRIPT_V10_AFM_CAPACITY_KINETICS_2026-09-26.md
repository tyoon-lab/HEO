# HEO Manuscript v10 — AFM-Target Capacity–Kinetics / GITT Ranking Draft

**Date:** 2026-09-26  
**Status:** TY10-integrated observable-contradiction architecture; BM capacity–kinetics mismatch is the primary scientific event, GITT apparent-diffusivity inversion is the independent kinetic-ranking test, EIS is excluded from the manuscript logic, and microkinetics is retained as a bounded existence proof  
...
Figure 5 therefore establishes that the mismatch identified in Figure 4 is associated with the conversion region itself rather than with a generic relaxation background. The next question is whether this relation is confined to the first conversion or persists as the electrode evolves with cycling.
