# HEO Figures 3–7 — Current Logic, 2026-09-26 (v3, toolkit-aligned)

## Manuscript question

**Can higher accessible conversion capacity coexist with slower conversion-associated relaxation, and does conventional GITT apparent diffusivity preserve the same kinetic ordering?**
...
## Figure 4 — Primary contradiction: capacity up, relaxation slower; conventional GITT ranks the opposite
...
**Microkinetic analysis shows that the observed capacity–relaxation mismatch can arise naturally from multistep conversion. Capacity, apparent diffusivity, and relaxation should not be collapsed onto a single fast–slow kinetic coordinate.**
