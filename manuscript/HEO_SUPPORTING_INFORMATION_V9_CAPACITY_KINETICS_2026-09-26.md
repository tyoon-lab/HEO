...
|---|---:|---:|---:|---:|---:|
| reference | -3.0 | 1.0 | 0.55845 | 33.02 | 13.78 |
| illustrative Mg-like | -2.0 | 0.8 | 0.39339 | 28.64 | 16.78 |
...
simultaneously. Relative to the reference, the illustrative case decreases cutoff capacity by 29.6%, decreases the matched-state relaxation amplitude by 13.3%, and increases $t_{63}$ by 21.8%.

For reproducibility, this matched-state calculation is generated by `modeling/heo_capacity_relaxation_heterogeneous_validation.py` from a common initial state at normalized passed charge $\Delta Q=0.30$ using the fixed cutoff protocol. These values supersede the earlier provisional Mg-like table; the directional conclusion is unchanged.
