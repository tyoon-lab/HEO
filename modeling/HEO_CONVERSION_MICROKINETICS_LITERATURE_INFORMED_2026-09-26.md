# HEO Conversion Microkinetics — Literature-Informed Model (2026-09-26 Authority)

**Date:** 2026-09-26  
**Status:** current Figure 7/SI model authority; retains the BM-like heterogeneous-accessibility existence proof and adds a bounded Mg-like directional test.
...
- modeling/HEO_MG_LIKE_MICROKINETIC_DIRECTIONAL_TEST_2026-09-26.csv

## 9. Mg-like directional test

A secondary calculation tests the complementary experimental Mg combination:
...
This is a directional existence proof only. It does not assign Mg incorporation to $u_3$, $R_2$, or any unique microscopic process.

Detailed audit:
- modeling/HEO_MG_LIKE_MICROKINETIC_DIRECTIONAL_TEST_2026-09-26.md
- modeling/HEO_MG_LIKE_MICROKINETIC_DIRECTIONAL_TEST_2026-09-26.csv

## 10. Figure 7 interpretation
